...
import { register, googleLogin, getMe } from "../services/api";
...
export default function RegisterPage() {
  ...
  const handleGoogleSuccess = async (tokenResponse) => {
    ...
    setError("");
    try {
      // @react-oauth/google returns an access_token for the userinfo endpoint
      // We fetch the id_token via the token endpoint approach.
      // With useGoogleLogin flow="auth-code", we get an authorization code.
      // Here we use the implicit token flow (access_token) to get user info,
      // then pass as id_token since backend verifies via Google's userinfo.
      // For simplicity, we pass the access_token as id_token and the backend
      // should be configured for access_token verification.
      // NOTE: For production, use flow="auth-code" server-side exchange.
      ...
      // Call our backend with the access_token
